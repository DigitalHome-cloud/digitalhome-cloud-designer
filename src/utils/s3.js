...
// ─── Device Inventory ──────────────────────────────────────────────────────
//
// Catalogue assets (model docs/img/specs) live under the world-readable,
// admin-write `public/catalogue/devices/...` prefix → direct Amplify Storage
// (same flow as the ontology toolbox). Per-device instance files are
// tenant-scoped and go through the signed-URL proxy: the Lambda resolves
// Private/ vs Public/ from DigitalHome.isDemo, so the client never picks the
// root.
